...
curl -k -s -o /tmp/AdGuardHome/AdGuardHome --connect-timeout 10 --retry 3 https://jsd.cdn.zzko.cn/gh/jasonandy999/Padavan-KVR@main/trunk/user/adguardhome/AdGuardHome
